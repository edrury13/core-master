...
SFX_IMPL_STATUSBAR_CONTROL(ScTimerStatusBarControl, SfxStringItem);

ScTimerStatusBarControl::ScTimerStatusBarControl(
        sal_uInt16 _nSlotId,
        sal_uInt16 _nId,
        StatusBar& rStb) :
    SfxStatusBarControl(_nSlotId, _nId, rStb)
{
    ...
    SAL_INFO("sc.ui", "ScTimerStatusBarControl created with slot " << _nSlotId);
}
...
void ScTimerStatusBarControl::StateChangedAtStatusBarControl(
...
void ScTimerStatusBarControl::Click()
{
